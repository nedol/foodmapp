        ...
        for(let of in ar) {
            ...
            for (let tab in offer.data) {
                ...
                for (let i in offer.data[tab]) {
                    ...
                    $(menu_item).attr("supuid", ar[of].supuid);
                    ...
                    $(menu_item).find('.item_price').text(offer.data[tab][i].price * .2);
                    ...
                    $(menu_item).find('.item_pack').attr('packlist', JSON.stringify(offer.data[tab][i].packlist));
    ...
    GetOfferItems(lang){
        ...
        $('#offer_editor').find('.div_tab_inserted').each((index, val)=> {
            ...
            for (let i = 0; i < miAr.length; i++) {
                ...
                item.supuid = $(miAr[i]).attr('supuid');;
