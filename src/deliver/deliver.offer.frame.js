...
$(document).on('readystatechange', function () {
    ...
    window.InitSupplierOffer = function (data) {
        if(!window.sup_off )
            window.sup_off = new DeliverOffer();
...
class DeliverOffer{
    ...
    OpenOffer(obj) {
        ...
        $.each(res, function (i, item) {
            ...
            for (let k in kAr) {
                ...
                $("<tr style='text-align: center;" + tr_style + "' " + tr_disabled + ">" +
                    ...
                    "<td>" + (res[i].cus_profile.name ? res[i].cus_profile.name : '') + "</td>" +
        ...
        that.orders = res;
            ...
            that.dict.set_lang(window.parent.sets.lang, $('.div_tab_inserted'));
    ...
    FillProfile(profile){
        ...
        if(!profile.avatar) {
            ...
            $('.avatar').attr('src', this.path+'/images/'+profile.avatar);
            $('#profile_img').attr('src', this.path+'/images/'+profile.avatar);
        }
