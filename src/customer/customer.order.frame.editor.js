...
export class CustomerOrder{
    constructor(){
        ...
        this.path = 'https://delivery-angels.com/server/';
    ...
    openFrame(obj, targ_title, cb) {
        ...
        //$('iframe.kolmi').attr('src','../kolmi/kolmi.html?trans=all&role=user&abonent='+obj.profile.email) ;
                        ...
                        if(res.data[keys[k]].ordlist) {
                            ...
                            for (let q in ordlist) {
                                if (ordlist[q].qnty > 0) {
                                    ...
                                    $('.item_title[data-translate=' + keys[k] + ']').closest('.menu_item').addClass('ordered');
                                }
                            }
                        }
