...
export class CustomerOrder{
    ...
    openFrame(obj, targ_title, cb) {
        ...
        if(isDelayed)
            this.ovc.find('.actual_price').text({'ru':'Цены самовывоза на: ','en':'Pickup Prices for '}[window.parent.sets.lang]+obj.published.split('T')[0])
